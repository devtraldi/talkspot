"""
Django settings for TalkSpot project.
...
SECRET_KEY = 'django-insecure-tl^t+p+8*7=)rex8@r5@r4y+0*(i1=)d7=mss=0)a^uc9j-uz9'
...
WSGI_APPLICATION = 'TalkSpot.wsgi.application'
